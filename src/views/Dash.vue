    ...
    .container.flex.flex-col
      nav.py-4.w-full.flex.items-center.justify-between.mb-8
        ...
        div(class="w-1/3 bg-transparent flex items-center justify-end")
          p.text-white.uppercase.tracking-wide.text-sm.opacity-75.cursor-pointer.hover-opacity-100 https://forms.id
      .w-full.flex.flex-col.-mx-4.mb-12
        .flex.items-center.mx-4.pb-6
          p.text-white.uppercase.tracking-wide.text-sm.cursor-pointer.hover-opacity-100.mr-4 Today
          p.text-white.uppercase.tracking-wide.text-sm.opacity-75.cursor-pointer.hover-opacity-100.mr-4 Week
          p.text-white.uppercase.tracking-wide.text-sm.opacity-75.cursor-pointer.hover-opacity-100.mr-4 Month
          p.text-white.uppercase.tracking-wide.text-sm.opacity-75.cursor-pointer.hover-opacity-100.mr-4 Year
        .flex
      ...
      main-chart(:custom-tooltip.sync="customPageViews" v-on:update:custom-tooltip="customPageViews = $event")
</template>
